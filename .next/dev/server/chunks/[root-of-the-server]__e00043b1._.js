...
;
;
const PATH = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$data$2d$dir$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCrmDataDir"])(), 'inbound-synced-message-ids.json');
const MAX_IDS = 4000;
let mutex = Promise.resolve();
async function withLock(fn) {
    const run = mutex.then(()=>fn());
...
async function hasSyncedMessageId(id) {
    ...
    if (!norm) return false;
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isCrmPostgresEnabled"])()) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasInboundSyncIdPg"])(norm);
    }
    return withLock(async ()=>{
        try {
...
async function markMessageIdSynced(id) {
    ...
    if (!norm) return;
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isCrmPostgresEnabled"])()) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["markInboundSyncIdPg"])(norm);
        return;
    }
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$inbound$2d$sync$2d$state$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$inbound$2d$sync$2d$state$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function syncGmailInboundToCrm() {
    const user = process.env.EMAIL_USER?.trim();
    const pass = process.env.EMAIL_APP_PASSWORD ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$mail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeSmtpPassword"])(process.env.EMAIL_APP_PASSWORD) : '';
    if (!user || !pass) {
        ...
        try {
            ...
            for (const uid of slice){
                ...
                try {
                    ...
                    const htmlRaw = typeof parsed.html === 'string' && parsed.html ? parsed.html : undefined;
                    const bounceResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tryIngestBounceEmail"])({
                        fromHeader,
                        fromAddresses,
                        to: user,
                        subject: subjectLine,
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gmail$2d$inbound$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gmail$2d$inbound$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e00043b1._.js.map