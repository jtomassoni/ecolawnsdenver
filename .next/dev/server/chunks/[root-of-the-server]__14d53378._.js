...
"[project]/app/api/crm/leads/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    ...
    try {
        ...
        const lead = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateLead"])(id, patch);
        if (!lead) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Not found'
        }, {
            status: 404
...
async function DELETE(_request, { params }) {
    ...
    if (denied) return denied;
    const { id } = await params;
    const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteLead"])(id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__14d53378._.js.map