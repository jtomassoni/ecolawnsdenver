...
async function GET(_request, { params }) {
    ...
    const [commRes, invRes] = await Promise.all([
        supabase.from('communications').select('*').eq('lead_id', id).order('sent_at', {
            ascending: false
        }),
        supabase.from('invoices').select('*').eq('lead_id', id).order('created_at', {
            ascending: false
        })
    ]);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3a9c5d51._.js.map