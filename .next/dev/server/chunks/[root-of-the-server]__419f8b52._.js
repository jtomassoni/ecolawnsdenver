...
"[project]/lib/crm-data-dir.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/crm-pg.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$data$2d$dir$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/crm-data-dir.ts [app-route] (ecmascript)");
...
async function migrateJsonStoreIfEmpty(p) {
    ...
    const storePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$data$2d$dir$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCrmDataDir"])(), 'crm-store.json');
    try {
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/path [external] (path, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$data$2d$dir$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/crm-data-dir.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/crm-pg.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
;
;
const DATA_DIR = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$data$2d$dir$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCrmDataDir"])();
...
async function readDb() {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isCrmPostgresEnabled"])()) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureCrmSchemaAndMigrate"])();
        const leads = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["loadAllLeadsFromPg"])();
        return {
            version: 1,
            leads
        };
...
async function persistLeadDb(db, lead) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isCrmPostgresEnabled"])()) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureCrmSchemaAndMigrate"])();
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveLeadToPg"])(lead);
    } else {
        await writeDb(db);
    }
}
async function persistDeleteDb(db, id) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isCrmPostgresEnabled"])()) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureCrmSchemaAndMigrate"])();
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$pg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteLeadFromPg"])(id);
    } else {
        await writeDb(db);
    }
}
...
"[project]/lib/crm-email-templates.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    ()=>CRM_EMAIL_TEMPLATE_IDS,
    "CRM_EMAIL_TEMPLATE_LABELS",
    ()=>CRM_EMAIL_TEMPLATE_LABELS,
    "LAWN_CUT_NOTICE_SUBJECT",
    ()=>LAWN_CUT_NOTICE_SUBJECT,
    "MOW_REMINDER_SUBJECT_TEMPLATE",
    ()=>MOW_REMINDER_SUBJECT_TEMPLATE,
    "buildCrmEmailFromTemplate",
    ()=>buildCrmEmailFromTemplate,
    "buildLawnCutNoticeEmail",
    ()=>buildLawnCutNoticeEmail,
    "buildMowReminderEmail",
    ()=>buildMowReminderEmail
]);
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
const MOW_REMINDER_SUBJECT_TEMPLATE = 'Reminder: lawn service {{service_day}}';
...
— EcoLawns Denver`;
const LAWN_CUT_NOTICE_SUBJECT = "We've cut your lawn";
...
— EcoLawns Denver`;
const CRM_EMAIL_TEMPLATE_IDS = [
    'mow_reminder',
    'lawn_cut_notice'
];
const CRM_EMAIL_TEMPLATE_LABELS = {
...
function leadTemplateVars(lead, extra) {
    return {
...
function buildMowReminderEmail(lead, options) {
    const raw = (options?.serviceDayLabel ?? '').trim();
    const serviceDay = raw || 'tomorrow';
    const vars = leadTemplateVars(lead, {
        service_day: serviceDay
    });
    const subject = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyTemplateVars"])(MOW_REMINDER_SUBJECT_TEMPLATE, vars);
    const text = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyTemplateVars"])(MOW_REMINDER_BODY, vars);
    return {
        subject,
        text,
...
function buildLawnCutNoticeEmail(lead) {
    const vars = leadTemplateVars(lead, {});
    const text = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyTemplateVars"])(LAWN_CUT_NOTICE_BODY, vars);
    return {
        subject: LAWN_CUT_NOTICE_SUBJECT,
        text,
        html: textToSimpleHtml(text)
    };
}
function buildCrmEmailFromTemplate(templateId, lead, options) {
...
function getMailTransporter() {
    ...
    const pass = process.env.EMAIL_APP_PASSWORD ? normalizeSmtpPassword(process.env.EMAIL_APP_PASSWORD) : '';
 ...
 */ function getCrmSmtpTransporter() {
    ...
    const pass = process.env.CRM_SMTP_PASSWORD ? normalizeSmtpPassword(process.env.CRM_SMTP_PASSWORD) : '';
    if (user && pass) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createTransport({
            service: 'gmail',
            auth: {
...
"[project]/app/api/crm/leads/[id]/macros/email-template/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/crm-email-templates.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/crm-store.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
function isTemplateId(id) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CRM_EMAIL_TEMPLATE_IDS"].includes(id);
}
async function POST(request, { params }) {
    ...
    if (!templateId || !isTemplateId(templateId)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: `templateId must be one of: ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CRM_EMAIL_TEMPLATE_IDS"].join(', ')}`
        }, {
            status: 400
        });
    }
    const serviceDayLabel = body.serviceDayLabel !== undefined ? String(body.serviceDayLabel) : undefined;
    const built = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildCrmEmailFromTemplate"])(templateId, lead, {
        serviceDayLabel
    });
    if (!built) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    let messageId;
    try {
        const sent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crm$2d$mail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendCrmEmail"])({
            to: toAddr,
            subject,
            text,
            html
...
//# sourceMappingURL=%5Broot-of-the-server%5D__419f8b52._.js.map